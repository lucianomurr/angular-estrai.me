...
@Component({
  ...
  template: `
    <div class="flex justify-center mb-8" *ngIf="status !== 'closed'; else showClosedMessage">
      <button
    ...
    <ng-template #showClosedMessage>
      <div class="flex justify-center mb-8">
        <p class="mb-12 text-2xl font-normal text-center text-gray-500 dark:text-gray-300">
