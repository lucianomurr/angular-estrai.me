      ...
      <div class="grid grid-flow-row-dense grid-cols-2 grid-rows-1">
        <div class="">
          ...
          <app-cta-game
            ...
            [status]="gameDetails[0].status"></app-cta-game>
        </div>
        <div class="">
          <p class="mb-12 text-xl font-normal text-center text-gray-500 dark:text-gray-300">
            waiting for the users in the game<span class="animate-pulse">...</span>
          </p>
          <div
            class="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-6"
