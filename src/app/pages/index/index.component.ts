        ...
        <div class="container relative flex px-6 py-16 mx-auto">
            <div class="relative z-20 flex flex-col sm:w-2/3 lg:w-2/5">
                ...
                <p class="text-sm text-gray-700 sm:text-base dark:text-white">
                    This game is for people who organize a simple raffle game in a meeting or meetup!
                ...
                <div class="flex mt-8">
                    ...
                    <a href="#" class="px-4 py-2 text-red-600 uppercase bg-transparent border-2 border-red-600 rounded-lg dark:text-white hover:bg-red-600 hover:text-white text-md">
                        Read more
                    </a>
                </div>
            </div>
