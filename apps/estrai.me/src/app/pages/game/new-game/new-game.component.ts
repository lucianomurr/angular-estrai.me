...
import { RaffleGameService, RaffleDocument } from '../../../shared/services/raffe-game.service';
      ...
      <div class="container relative flex px-6 py-16 mx-auto">
        <div class="relative z-10 flex flex-col sm:w-2/3 lg:w-4/5">
          ...
          <p class="text-sm text-gray-700 sm:text-base dark:text-white">
            Here you can create your new online raffle game to give away your prizes. To get started, choose a name for
            your new online game and proceed! Good luck!
          </p>
          ...
          <div class="bg-white dark:bg-gray-800 ">
            <div
              ...
              <h2 class="text-3xl font-extrabold text-black dark:text-white sm:text-4xl">
                ...
                <span class="block text-indigo-500"> Ready? </span>
              </h2>
