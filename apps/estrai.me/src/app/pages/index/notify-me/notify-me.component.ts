      ...
      >
        <div class="flex justify-center xl:w-1/2">
          <img
            ...
            src="./assets/undraw_developer_activity.svg"
            alt=""
          />
        </div>
        ...
        >
          <h2
            class="text-3xl font-semibold tracking-tight text-gray-800 xl:text-4xl dark:text-white"
          >
            Do you want to contribute to the project?
          </h2>

          <p class="block max-w-2xl mt-4 text-gray-500 dark:text-gray-300">
            Follow the project, share your feedback and if you are confident
            with coding, contribute to add more features and cool things to the
            application!
          </p>
          ...
          <div class="mt-6 sm:-mx-2">
            ...
            >
              ...
              <span class="mx-2">
                Estrai.me is open source, check the code on Github
              </span>
            </a>
          </div>
        </div>
