      ...
      <div class="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
        ...
        <div class="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
          ...
          <p class="block max-w-2xl mt-4 text-gray-500 dark:text-gray-300">
            Follow the project, share your feedback and if you are confident with coding, contribute to add more
            features and cool things to the application!
          </p>
          ...
          <div class="mt-6 sm:-mx-2">
            <a
              ...
              <span class="mx-2"> Estrai.me is open source, check the code on Github </span>
            </a>
          </div>
        </div>
      </div>
