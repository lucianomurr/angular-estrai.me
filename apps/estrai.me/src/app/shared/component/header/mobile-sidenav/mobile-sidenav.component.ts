...
@Component({
  ...
  template: ` <div
    ...
    [ngClass]="{
      'translate-x-0': showSidebar === true,
  ...
  >
    <div class="space-y-3">
      ...
      <div class="flex-1">
        ...
        <ul
          ...
          *ngIf="auth.authState | async as loggedUser; else showLoginAside"
        >
          <li class="rounded-sm">
            <a
              rel="noopener noreferrer"
    ...
    <div
      class="flex items-center p-2 mt-12 space-x-4 justify-self-end"
      *ngIf="auth.authState | async as loggedUser"
    >
      <img
